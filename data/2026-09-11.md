...
### [1] [The $q$-deformed cross-ratio: modular invariants and Coxeter friezes](https://arxiv.org/abs/2609.10999)
*Valentin Ovsienko*
...
### [2] [Generalized Jantzen filtration, hyperbolic restriction, and characteristic cycles](https://arxiv.org/abs/2608.29312)
*Johannes Droschl*
...
### [3] [Noncommutative resolutions of affine Schubert varieties in type A and canonical bases](https://arxiv.org/abs/2606.15981)
...
### [4] [Representations of Super Yangians with Gelfand-Tsetlin bases](https://arxiv.org/abs/2604.25462)
...
Abstract: The evaluation homomorphism from the super Yangian $\mathrm Y(\mathfrak{gl}_{m|n})$ to the universal enveloping algebra $\mathrm U(\mathfrak{gl}_{m|n})$ allows one to regard the $\mathfrak{gl}_{m|n}$-modules as $\mathrm Y(\mathfrak{gl}_{m|n})$-modules. In this paper, we establish necessary and sufficient conditions for simple tensor products of covariant evaluation modules to be tame. We also provide an explicit construction of Gelfand-Tsetlin bases for tensor products of skew modules.
...
### [5] [Tensor hierarchy from deformation quantisation](https://arxiv.org/abs/2609.10692)
...
### [6] [The generalised semi-Clifford conjecture is false](https://arxiv.org/abs/2609.11903)
...
### [7] [Power counting in the spectral action matrix model](https://arxiv.org/abs/2512.14581)
...
### [8] [Normalized quadratic extensions of pointed Hopf algebras](https://arxiv.org/abs/2609.11622)
*Rongchuan Xiong*
...
### [9] [Gelfand--Tsetlin bases for representations of $\mathrm U_{q}(\mathfrak{gl}_n)$ at roots of unity](https://arxiv.org/abs/2609.11471)
...
### [10] [Some finite dimensional representations of shifted quantum affine algebras of type A](https://arxiv.org/abs/2609.11337)
...
### [11] [On Diagrammatic Categorification of Verma Modules I: Braiding](https://arxiv.org/abs/2609.10941)
*Pedro Guicardi*
...
### [12] [Operator Michelson Contrast: Logarithmic Parametrisation, Subadditivity, and a Sharp Noncommutativity Threshold](https://arxiv.org/abs/2609.06997)
...
### [13] [A note on the center of the queer super Yangian ${\rm Y}(\mathfrak{q}_1)$](https://arxiv.org/abs/2608.30293)
...
Abstract: We investigate two families of central elements of the queer super Yangian ${\rm Y}(\mathfrak{q}_1)$, arising from the constructions of Poletaeva-Serganova and from Nazarov's quantum Berezinian. We establish an explicit relation between their generating series, thereby giving an answer to the question raised by Nazarov in \cite{Na22}.

</details>


### [14] [Modular Zhu algebra theory and Virasoro vertex algebras](https://arxiv.org/abs/2607.05584)
*Colton Griffin*
...
### [15] [The Chen-Yang volume conjecture for long integral fillings of fundamental shadow links](https://arxiv.org/abs/2609.11839)
*Ce Shen*
